...
public class ChiSquareTest extends AbstractProblem {
   
   public static void main(String args[]){
      String[] str={"-log","SOLUTION"};
      
      double[][] valuesA = {{2,2},{-1,-1},{0,0},{3,3},{1,1},{2,2}};
      double[][] valuesB = {{2,2},{-1,-1},{0,0},{3,3},{1,1},{2,2}};
      ...
      //ChiSquareTest cs = new ChiSquareTest(values, binCounts, binBounds, normalMean, normalStd, chiSqStatistic);
      //cs.execute(str);
   }
   ...
   public ChiSquareTest(double[][] values,
                        int[][] binCounts, 
                        double[] binBounds,
                        double[] normalMean,
                        double[] normalStd,
